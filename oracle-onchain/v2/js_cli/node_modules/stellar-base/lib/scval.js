...
function nativeToScVal(val) {
  var _val$constructor$name, _val$constructor, _opts$type3;
  ...
  switch (_typeof(val)) {
    ...
    case 'string':
      switch ((_opts$type3 = opts === null || opts === void 0 ? void 0 : opts.type) !== null && _opts$type3 !== void 0 ? _opts$type3 : 'string') {
        case 'string':
...
function scValToNative(scv) {
  ...
  switch (scv["switch"]().value) {
    ...
    case _xdr["default"].ScValType.scvAddress().value:
      return _address.Address.fromScVal(scv);
