...
from stellar_sdk.soroban import types, SorobanServer
from stellar_sdk.soroban.soroban_rpc import GetTransactionStatus
from stellar_sdk.soroban.types import Uint32, Address


class Soroban:
    def invoke_contract(prompt, contract_id):
        if prompt == 1:
            # Sample args for create function
            args = [
            ...
            # Sample args for update function
            args = [
                Address("GALGFV6YVKMVAWHK6QA7GCC67VKBW73A3PB5IKZGKT5ID5AGK4S3Y7GX"),
                Uint32(5),
                Uint32(5),
            ...
            # Empty args for get and delete functions
            args = []
    ...
    def invoke(args, fun_name, contract_id):
        ...
        try:
            kp = Keypair.from_secret(config.secret)
            soroban_server = SorobanServer(config.rpc_server_url)
            source = soroban_server.load_account(kp.public_key)

            # build a transaction that invokes the function
            tx = (
            ...
            if get_transaction_data.status == GetTransactionStatus.SUCCESS:
                ...
                if fun_name == "create" or fun_name == "update" or fun_name == "delete":
                    ...
                    # No default decode function available right now, decoding responses based on my parameters
